    ...
    <div class="n-plist">
        ...
        <#if user && user.userType == 0 && listType == 1>
            <#list productList as x>
                <#if !x.isBuy>
                <li id="p-${x.id}">
                    <a href="/supermarket/show?id=${x.id}" class="link">
            ...
            <#list productList as x>
                <li id="p-${x.id}">
                    <a href="/supermarket/show?id=${x.id}" class="link">
                        ...
                        <h3>${x.title}</h3>
                        <div class="price"><span class="v-unit">¥</span><span class="v-value">${x.price}</span></div>
                        <#if user && user.userType==0 && x.isBuy==true><span class="had"><b>已购买</b></span></#if>
...
<script type="text/javascript" src="/supermarket/js/pageIndex.js"></script>
</body>
</html>